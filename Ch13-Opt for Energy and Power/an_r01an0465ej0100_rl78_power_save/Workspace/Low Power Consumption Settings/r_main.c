...
__root const uint8_t opbyte0 = 0x6EU; // 0110 1110
#pragma location = "OPTBYTE"
__root const uint8_t opbyte1 = 0x1FU; // 0001 1111
#pragma location = "OPTBYTE"
__root const uint8_t opbyte2 = 0x2BU; // 0010 1011
#pragma location = "OPTBYTE"
...
static const uint8_t	led_pattern[5] =				/* LED0-LED2 pattern */
{
	...
	/* |||||+---------  P54:LED6	ON:STOP mode */
	/* ||||||+--------  P53:LED5	ON:HALT mode */
	/* |||||||+-------  P52:LED4	ON:fCLK = fIH OFF:fCLK = fSUB */
 	 0x18 /* MODE_OCO_RUN		LED0 = ON,  LED1 = OFF, LED2 = OFF */
	,0x10 	/* MODE_OCO_HALT	LED0 = ON,  LED1 = ON,  LED2 = OFF */
	,0x08 /* MODE_OCO_STOP	LED0 = ON,  LED1 = OFF, LED2 = ON  */
	,0x1C /* MODE_SUB_RUN		LED0 = OFF, LED1 = OFF, LED2 = OFF */
	,0x14 /* MODE_SUB_HALT	LED0 = OFF, LED1 = ON,  LED2 = OFF */
};
/* End user code. Do not edit comment generated here */
...
//	EI();
	...
	while (1U)
	{
		...
		if (P13_bit.no7 == 0)			/* No chattering action on INTP0 ? */
		{						/* Yes */
			/* Update operate mode */
