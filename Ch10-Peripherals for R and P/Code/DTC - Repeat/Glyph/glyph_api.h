...
{
    uint8_t strVersionAPI[20] ;
    uint8_t strVersionIMPL[20] ;
    int8_t nVersionAPIMajor ;
    int8_t nVersionAPIMinor ;
    int8_t nVersionIMPLMajor ;
    int8_t nVersionIMPLMinor ;
    int8_t nImplementationID ;
} T_glyphVersionInfo ;
...
typedef struct {
    ...
    uint8_t iCharFont;
    uint8_t iFP_API_MAJOR_VERSION;
    uint8_t iFP_API_MINOR_VERSION;
    uint8_t iFP_IMPLEMENTATION_ID;
    uint8_t iFP_IMPL_MAJOR_VERSION;
    uint8_t iFP_IMPL_MINOR_VERSION;
