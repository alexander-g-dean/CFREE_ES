...
void R_DTC_Create(void)
{
    ...
    dtc_controldata_0.dtccr = _01_DTC_TRANSFER_MODE_REPEAT | _00_DTC_REPEAT_AREA_DEST | _00_DTC_SOURCE_ADDR_FIXED |
                              _00_DTC_CHAIN_TRANSFER_DISABLE | _20_DTC_REPEAT_INT_ENABLE;
    dtc_controldata_0.dtbls = _02_DTCD0_TRANSFER_BLOCKSIZE;
    dtc_controldata_0.dtcct = _60_DTCD0_TRANSFER_BYTE;
    dtc_controldata_0.dtrld = _60_DTCD0_TRANSFER_BYTE;
    dtc_controldata_0.dtsar = _FF1E_DTCD0_SRC_ADDRESS;
    dtc_controldata_0.dtdar = _C000_DTCD0_DEST_ADDRESS;
}
