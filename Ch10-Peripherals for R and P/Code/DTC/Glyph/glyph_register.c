...
#include "Drivers/YRDKRL78_LCD.h"
...
T_glyphError GlyphCommOpen(T_glyphHandle aHandle, int16_t aAddress)
{
    ...
    switch (aAddress) {
        case 0:
             p_gw->iCommAPI->iOpen        = YRDKRL78_RSPIOpen;
             p_gw->iCommAPI->iCommandSend = YRDKRL78_CommandSend;
             p_gw->iCommAPI->iDataSend    = YRDKRL78_DataSend;
             break;
